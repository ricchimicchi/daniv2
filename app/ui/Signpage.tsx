    ...
    <div className="relative">
      ...
      <div className={`absolute inset-x-0 top-52 px-4 ${space.className}`}>
        ...
        <p className="text-sm font-medium dark:text-[#7c7c7c] mt-2 text-center flex items-center gap-2 justify-center">
          {" "}
          {loading ? "This process might take 1 or 2 minutes" : <>Doesn't have activate Key? <Link href={'/'} target="_blank" className="flex items-center gap-1 underline dark:text-white">Buy <MdOutlineArrowOutward /></Link></>}
        </p>
      </div>
    </div>
  );
